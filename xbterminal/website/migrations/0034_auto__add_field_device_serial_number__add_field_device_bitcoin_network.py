...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Device.serial_number'
        db.add_column(u'website_device', 'serial_number',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Device.bitcoin_network'
        db.add_column(u'website_device', 'bitcoin_network',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Device.serial_number'
        db.delete_column(u'website_device', 'serial_number')

        # Deleting field 'Device.bitcoin_network'
        db.delete_column(u'website_device', 'bitcoin_network')
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'1448a8f931ec4ab196bc3d1e971e7d65'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'77f884a5d0a845c7b87e8853ea2c8f56'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'512fa066ea14442fbbb2f86f72eb31a9'", 'unique': 'True', 'max_length': '32'}),
