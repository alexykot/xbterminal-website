...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BTCAccount'
        db.create_table(u'website_btcaccount', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('merchant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.MerchantAccount'])),
            ('network', self.gf('django.db.models.fields.CharField')(default='mainnet', max_length=50)),
            ('balance', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=8)),
            ('balance_max', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=8)),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True)),
        ))
        db.send_create_signal(u'website', ['BTCAccount'])


    def backwards(self, orm):
        # Deleting model 'BTCAccount'
        db.delete_table(u'website_btcaccount')
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'SUb3WEv5'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'974f6ad9110b403983face923e2361fe'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.order': {
            ...
            'payment_reference': ('django.db.models.fields.CharField', [], {'default': "u'LBFXYGZIGE'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "u'XTLP6c'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'90c9b035730e4108ac8eaa437bda1466'", 'unique': 'True', 'max_length': '32'}),
