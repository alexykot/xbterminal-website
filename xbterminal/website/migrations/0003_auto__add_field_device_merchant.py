...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Device.merchant'
        db.add_column(u'website_device', 'merchant',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['website.MerchantAccount']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Device.merchant'
        db.delete_column(u'website_device', 'merchant_id')
