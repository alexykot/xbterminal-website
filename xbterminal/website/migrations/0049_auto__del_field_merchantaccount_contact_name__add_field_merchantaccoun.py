...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'MerchantAccount.contact_name'
        db.rename_column(u'website_merchantaccount', 'contact_name', 'contact_first_name')

        # Adding field 'MerchantAccount.contact_last_name'
        db.add_column(u'website_merchantaccount', 'contact_last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1000),
                      keep_default=False)


    def backwards(self, orm):
        # Renaming field 'MerchantAccount.contact_first_name'
        db.rename_column(u'website_merchantaccount', 'contact_first_name', 'contact_name')

        # Deleting field 'MerchantAccount.contact_last_name'
        db.delete_column(u'website_merchantaccount', 'contact_last_name')
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'ee0289aa496a443983889d39f3e66193'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'fc16a4c9bbc94643bd0c6a841d419486'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.merchantaccount': {
            ...
            'contact_first_name': ('django.db.models.fields.CharField', [], {'max_length': '1000'}),
            'contact_last_name': ('django.db.models.fields.CharField', [], {'max_length': '1000'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'f5a8eddb90204ed79db2899cdb22ae08'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'abbe22d290da427cb8f05c81c6b91cea'", 'unique': 'True', 'max_length': '32'}),
