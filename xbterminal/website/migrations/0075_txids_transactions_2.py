...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for transaction in orm.Transaction.objects.filter(id__range=(225, 276)):
            outgoing_tx_hash = x(transaction.bitcoin_transaction_id_2)
            transaction.bitcoin_transaction_id_2 = b2lx(outgoing_tx_hash)
            transaction.save()

    def backwards(self, orm):
        for transaction in orm.Transaction.objects.filter(id__range=(225, 276)):
            outgoing_tx_hash = lx(transaction.bitcoin_transaction_id_2)
            transaction.bitcoin_transaction_id_2 = b2x(outgoing_tx_hash)
            transaction.save()
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'So99bD8C'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'54486a437e6f4aa0bdb5a265b0890d83'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.order': {
            ...
            'payment_reference': ('django.db.models.fields.CharField', [], {'default': "u'AWP3JUIX4P'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'1302449908de4dd9a019ed81d68c273d'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'e47658761f91482fa71fed90389c4223'", 'unique': 'True', 'max_length': '32'}),
