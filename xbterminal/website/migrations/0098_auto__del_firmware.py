...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'website_firmware', (
            ...
            ('hash', self.gf('django.db.models.fields.CharField')(default='9495eb30eb674e03a4f539602df6d542', max_length=32, unique=True)),
            ('version', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('filename', self.gf('website.fields.FirmwarePathField')(path='/var/firmware', max_length=100)),
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'FtL5bxTL'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.order': {
            ...
            'payment_reference': ('django.db.models.fields.CharField', [], {'default': "u'Y34RPN6QRB'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "u'2dWTEv'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.withdrawalorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "u'NuQPP5'", 'unique': 'True', 'max_length': '32'})
        }
    }
