...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Device.payment_processor'
        db.alter_column(u'website_device', 'payment_processor', self.gf('django.db.models.fields.CharField')(default='', max_length=50))
    ...
    models = {
        ...
        u'website.device': {
            ...
            'payment_processor': ('django.db.models.fields.CharField', [], {'default': "'BitPay'", 'max_length': '50', 'null': 'True'}),
