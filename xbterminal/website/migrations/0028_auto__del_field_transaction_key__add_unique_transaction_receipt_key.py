...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Transaction.key'
        db.delete_column(u'website_transaction', 'key')

        # Adding unique constraint on 'Transaction', fields ['receipt_key']
        db.create_unique(u'website_transaction', ['receipt_key'])


    def backwards(self, orm):
        # Removing unique constraint on 'Transaction', fields ['receipt_key']
        db.delete_unique(u'website_transaction', ['receipt_key'])

        # Adding field 'Transaction.key'
        db.add_column(u'website_transaction', 'key',
                      self.gf('django.db.models.fields.CharField')(default='4a563847f875414db45ba7542df76cb0', max_length=32, unique=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'d4b35b68901a4ec2a43cdf46bd09bdb6'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'a65e56f289514c338f624637ebd6f70c'", 'unique': 'True', 'max_length': '32'}),
