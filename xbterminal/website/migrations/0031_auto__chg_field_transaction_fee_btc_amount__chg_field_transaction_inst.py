...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Transaction.fee_btc_amount'
        db.alter_column(u'website_transaction', 'fee_btc_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=8))

        # Changing field 'Transaction.instantfiat_fiat_amount'
        db.alter_column(u'website_transaction', 'instantfiat_fiat_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=2))

        # Changing field 'Transaction.instantfiat_btc_amount'
        db.alter_column(u'website_transaction', 'instantfiat_btc_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=8))

    def backwards(self, orm):

        # Changing field 'Transaction.fee_btc_amount'
        db.alter_column(u'website_transaction', 'fee_btc_amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=18, decimal_places=8))

        # Changing field 'Transaction.instantfiat_fiat_amount'
        db.alter_column(u'website_transaction', 'instantfiat_fiat_amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=2))

        # Changing field 'Transaction.instantfiat_btc_amount'
        db.alter_column(u'website_transaction', 'instantfiat_btc_amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=18, decimal_places=8))
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'e83aab184578497e8f8c2842dcc8a925'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'a4af728696b64de0bb4fe1923fe5620e'", 'unique': 'True', 'max_length': '32'}),
