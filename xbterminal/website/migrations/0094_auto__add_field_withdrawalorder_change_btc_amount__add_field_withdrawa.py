...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WithdrawalOrder.change_btc_amount'
        db.add_column(u'website_withdrawalorder', 'change_btc_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=18, decimal_places=8),
                      keep_default=False)

        # Adding field 'WithdrawalOrder.reserved_outputs'
        db.add_column(u'website_withdrawalorder', 'reserved_outputs',
                      self.gf('django.db.models.fields.BinaryField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WithdrawalOrder.change_btc_amount'
        db.delete_column(u'website_withdrawalorder', 'change_btc_amount')

        # Deleting field 'WithdrawalOrder.reserved_outputs'
        db.delete_column(u'website_withdrawalorder', 'reserved_outputs')
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'Qnv6hSsJ'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'bf89c370f2ac412d87beea25d3092a69'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.order': {
            ...
            'payment_reference': ('django.db.models.fields.CharField', [], {'default': "u'QZC8QSEPZP'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "u'TWZ5Aq'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'306388f18e594ebf8199dbc00ecc22ca'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.withdrawalorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "u'VWRAKq'", 'unique': 'True', 'max_length': '32'})
        }
    }
