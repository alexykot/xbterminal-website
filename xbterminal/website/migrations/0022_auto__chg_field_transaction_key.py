...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Transaction.key'
        db.alter_column(u'website_transaction', 'key', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32))

    def backwards(self, orm):

        # Changing field 'Transaction.key'
        db.alter_column(u'website_transaction', 'key', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32, null=True))
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'63faabd5913f48549c1df513ed160eb8'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.transaction': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'ae41695b27c74960bb713ce72752ff61'", 'unique': 'True', 'max_length': '32'}),
