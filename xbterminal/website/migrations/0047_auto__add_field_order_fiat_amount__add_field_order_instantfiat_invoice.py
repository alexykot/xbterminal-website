...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.fiat_amount'
        db.add_column(u'website_order', 'fiat_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=8),
                      keep_default=False)

        # Adding field 'Order.instantfiat_invoice_id'
        db.add_column(u'website_order', 'instantfiat_invoice_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Order.instantfiat_btc_amount'
        db.add_column(u'website_order', 'instantfiat_btc_amount',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=18, decimal_places=8),
                      keep_default=False)

        # Adding field 'Order.instantfiat_address'
        db.add_column(u'website_order', 'instantfiat_address',
                      self.gf('django.db.models.fields.CharField')(max_length=35, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.fiat_amount'
        db.delete_column(u'website_order', 'fiat_amount')

        # Deleting field 'Order.instantfiat_invoice_id'
        db.delete_column(u'website_order', 'instantfiat_invoice_id')

        # Deleting field 'Order.instantfiat_btc_amount'
        db.delete_column(u'website_order', 'instantfiat_btc_amount')

        # Deleting field 'Order.instantfiat_address'
        db.delete_column(u'website_order', 'instantfiat_address')
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'3931396e4bc546438584c94988608c72'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'b654ecf9fa7e4d91a14be93b7a70033f'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.order': {
            ...
            'instantfiat_btc_amount': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '18', 'decimal_places': '8'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'5be5512beb01476097385024da5845c3'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'df13317627a5479080d630b44c1b9819'", 'unique': 'True', 'max_length': '32'}),
