...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Device.bitcoin_network'
        db.alter_column(u'website_device', 'bitcoin_network', self.gf('django.db.models.fields.CharField')(max_length=50, default='mainnet'))

    def backwards(self, orm):

        # Changing field 'Device.bitcoin_network'
        db.alter_column(u'website_device', 'bitcoin_network', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'UBcMXKyS'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'8739c4201d2a4725aa1111a1b9c64f59'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'bc3507065c254eca877fa95ad2f8db3f'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'47d8d125d49e4c5ba3ebd811352ac95f'", 'unique': 'True', 'max_length': '32'}),
