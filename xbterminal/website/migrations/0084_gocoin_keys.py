...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for merchant in orm.MerchantAccount.objects.filter(payment_processor='gocoin'):
            if merchant.api_key:
                merchant_id, api_key = merchant.api_key.split(':')
                merchant.api_key = api_key
                merchant.gocoin_merchant_id = merchant_id
                merchant.save()

    def backwards(self, orm):
        for merchant in orm.MerchantAccount.objects.filter(payment_processor='gocoin'):
            if merchant.api_key:
                merchant.api_key = merchant.gocoin_merchant_id + ':' + merchant.api_key
                merchant.gocoin_merchant_id = None
                merchant.save()
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'AJP91nEE'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'0490403fd1bc4b68917baa7e88899cac'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.order': {
            ...
            'payment_reference': ('django.db.models.fields.CharField', [], {'default': "u'8YJHEUFSLH'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'ffba0eb909d445488ca5fd1a8f1d596f'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'ae545eaf104f45aa945d7d105cb33410'", 'unique': 'True', 'max_length': '32'}),
