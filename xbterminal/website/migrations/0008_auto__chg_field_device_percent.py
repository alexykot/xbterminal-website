...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'website_device', 'percent', self.gf('django.db.models.fields.SmallIntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Device.percent'
        raise RuntimeError("Cannot reverse this migration. 'Device.percent' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Device.percent'
        db.alter_column(u'website_device', 'percent', self.gf('django.db.models.fields.SmallIntegerField')())
    ...
    models = {
        ...
        u'website.device': {
            ...
            'percent': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        u'website.language': {
