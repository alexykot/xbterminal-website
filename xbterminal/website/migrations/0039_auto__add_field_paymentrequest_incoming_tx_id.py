...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaymentRequest.incoming_tx_id'
        db.add_column(u'website_paymentrequest', 'incoming_tx_id',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PaymentRequest.incoming_tx_id'
        db.delete_column(u'website_paymentrequest', 'incoming_tx_id')
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'fc16a04c20ec417bbcdebc0a8bb8509b'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'9c3d14efdcea4901b72a1c1c064ce4b0'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.paymentrequest': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'5bc452872fdb406c9df01b5e44b4635b'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'8a0a599be8f74183bbb347ff37e1349a'", 'unique': 'True', 'max_length': '32'}),
