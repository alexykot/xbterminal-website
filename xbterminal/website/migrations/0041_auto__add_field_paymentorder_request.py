...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaymentOrder.request'
        db.add_column(u'website_paymentorder', 'request',
                      self.gf('django.db.models.fields.BinaryField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PaymentOrder.request'
        db.delete_column(u'website_paymentorder', 'request')
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'571d35e79a2c402e85df6f53370e89c9'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'2eef0239404d411ead0c15941651e9bd'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'b57678d3c0b94277b5e638a213205f40'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'66a0a1a621124b03b27a929d1f158e79'", 'unique': 'True', 'max_length': '32'}),
