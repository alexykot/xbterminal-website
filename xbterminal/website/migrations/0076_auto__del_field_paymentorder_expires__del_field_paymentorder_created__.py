...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PaymentOrder.expires'
        db.delete_column(u'website_paymentorder', 'expires')

        # Adding field 'PaymentOrder.time_recieved'
        db.add_column(u'website_paymentorder', 'time_recieved',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'PaymentOrder.time_forwarded'
        db.add_column(u'website_paymentorder', 'time_forwarded',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'PaymentOrder.time_broadcasted'
        db.add_column(u'website_paymentorder', 'time_broadcasted',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'PaymentOrder.time_exchanged'
        db.add_column(u'website_paymentorder', 'time_exchanged',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'PaymentOrder.time_finished'
        db.add_column(u'website_paymentorder', 'time_finished',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Renaming field 'PaymentOrder.created'
        db.rename_column(u'website_paymentorder', 'created', 'time_created')


    def backwards(self, orm):
        # Adding field 'PaymentOrder.expires'
        db.add_column(u'website_paymentorder', 'expires',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 9, 9, 0, 0)),
                      keep_default=False)

        # Deleting field 'PaymentOrder.time_recieved'
        db.delete_column(u'website_paymentorder', 'time_recieved')

        # Deleting field 'PaymentOrder.time_forwarded'
        db.delete_column(u'website_paymentorder', 'time_forwarded')

        # Deleting field 'PaymentOrder.time_broadcasted'
        db.delete_column(u'website_paymentorder', 'time_broadcasted')

        # Deleting field 'PaymentOrder.time_exchanged'
        db.delete_column(u'website_paymentorder', 'time_exchanged')

        # Deleting field 'PaymentOrder.time_finished'
        db.delete_column(u'website_paymentorder', 'time_finished')

        # Renaming field 'PaymentOrder.time_created'
        db.rename_column(u'website_paymentorder', 'time_created', 'created')
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'2tn5BzX9'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'54295f8521a54d7aa0b26ce6048b53ee'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.order': {
            ...
            'payment_reference': ('django.db.models.fields.CharField', [], {'default': "u'WRGFT4QRYB'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'0f203804c2dc4ac78ce4ba15c6236e5b'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'0c0b25fb703d424c9b48ae6067abb2e9'", 'unique': 'True', 'max_length': '32'}),
