...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'website_user_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('user', models.ForeignKey(orm[u'website.user'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['user_id', 'group_id'])

        # Adding M2M table for field user_permissions on 'User'
        m2m_table_name = db.shorten_name(u'website_user_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('user', models.ForeignKey(orm[u'website.user'], null=False)),
        ...
        # Changing field 'ReconciliationTime.email'
        db.alter_column(u'website_reconciliationtime', 'email', self.gf('django.db.models.fields.EmailField')(max_length=254))

        # Changing field 'MerchantAccount.contact_email'
        db.alter_column(u'website_merchantaccount', 'contact_email', self.gf('django.db.models.fields.EmailField')(unique=True, max_length=254))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'website_user_groups'))

        # Removing M2M table for field user_permissions on 'User'
        db.delete_table(db.shorten_name(u'website_user_user_permissions'))


        # Changing field 'ReconciliationTime.email'
        db.alter_column(u'website_reconciliationtime', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75))

        # Changing field 'MerchantAccount.contact_email'
        db.alter_column(u'website_merchantaccount', 'contact_email', self.gf('django.db.models.fields.EmailField')(max_length=75, unique=True))

        # Changing field 'MerchantAccount.user'
        db.alter_column(u'website_merchantaccount', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['auth.User']))
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'87Yrk4PG'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'95d0e8ee23dc4987beba540136c499f3'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'31e9bc94a02247f8a237e0b3a84e9a0a'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'2ba2839b40bf46d3b12f92ceef6e2e0d'", 'unique': 'True', 'max_length': '32'}),
