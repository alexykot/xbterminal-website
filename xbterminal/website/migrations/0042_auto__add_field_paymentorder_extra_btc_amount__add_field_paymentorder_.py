...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaymentOrder.extra_btc_amount'
        db.add_column(u'website_paymentorder', 'extra_btc_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=18, decimal_places=8),
                      keep_default=False)

        # Adding field 'PaymentOrder.outgoing_tx_id'
        db.add_column(u'website_paymentorder', 'outgoing_tx_id',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PaymentOrder.extra_btc_amount'
        db.delete_column(u'website_paymentorder', 'extra_btc_amount')

        # Deleting field 'PaymentOrder.outgoing_tx_id'
        db.delete_column(u'website_paymentorder', 'outgoing_tx_id')
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'8bb737006dd54a6a8c9fbd85ce0813a6'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'709b59ecaff846dba7f3db3d834ccfff'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'bc0af7327c3041dfbf14ba951f290186'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'f14408b596394e9f9ab346a3f06a08b0'", 'unique': 'True', 'max_length': '32'}),
