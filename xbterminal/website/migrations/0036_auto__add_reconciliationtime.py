...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReconciliationTime'
        db.create_table(u'website_reconciliationtime', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rectime_set', to=orm['website.Device'])),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('time', self.gf('django.db.models.fields.TimeField')()),
        ))
        db.send_create_signal(u'website', ['ReconciliationTime'])


    def backwards(self, orm):
        # Deleting model 'ReconciliationTime'
        db.delete_table(u'website_reconciliationtime')
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'90bff182757d47aba8670b8ed57a6528'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'aa9a121e565d488aa1a587973a9b712b'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'4919622adb26408f9469291b7efd7592'", 'unique': 'True', 'max_length': '32'}),
