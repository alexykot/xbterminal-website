...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'website_transaction', (
            ...
            ('source_address', self.gf('django.db.models.fields.CharField')(max_length=35)),
            ('hop_address', self.gf('django.db.models.fields.CharField')(max_length=35)),
            ('dest_address', self.gf('django.db.models.fields.CharField')(max_length=35)),
            ...
            ('amount', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=8)),
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'dfa43a80ea6c48188caee9d56f9cba5f'", 'unique': 'True', 'max_length': '32'}),
