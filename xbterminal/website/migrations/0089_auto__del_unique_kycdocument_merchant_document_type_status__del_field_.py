...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'KYCDocument', fields ['merchant', 'document_type', 'status']
        db.delete_unique(u'website_kycdocument', ['merchant_id', 'document_type', 'status'])

        # Deleting field 'MerchantAccount.verification_file_1'
        db.delete_column(u'website_merchantaccount', 'verification_file_1')

        # Deleting field 'MerchantAccount.verification_file_2'
        db.delete_column(u'website_merchantaccount', 'verification_file_2')


    def backwards(self, orm):
        # Adding unique constraint on 'KYCDocument', fields ['merchant', 'document_type', 'status']
        db.create_unique(u'website_kycdocument', ['merchant_id', 'document_type', 'status'])

        # Adding field 'MerchantAccount.verification_file_1'
        db.add_column(u'website_merchantaccount', 'verification_file_1',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MerchantAccount.verification_file_2'
        db.add_column(u'website_merchantaccount', 'verification_file_2',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'38i5Z4ys'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'efde566057ee42f0bfc3d89a880d0f30'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.order': {
            ...
            'payment_reference': ('django.db.models.fields.CharField', [], {'default': "u'EH4TF4ETCD'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'92e55376fdb04dc3a624de2f5dfbd202'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'d54011a3a0bf4364a58640c5b2d18a4f'", 'unique': 'True', 'max_length': '32'}),
