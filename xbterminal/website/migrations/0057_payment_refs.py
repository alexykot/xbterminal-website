...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for order in orm.Order.objects.all():
            ...
            order.payment_reference = base58.encode(bts)[:10].upper()
            order.save()
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'BgNuFVkv'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'a22feee018904dadac52853a9dffec8d'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.order': {
            ...
            'payment_reference': ('django.db.models.fields.CharField', [], {'default': "u'J2QWCYNTXV'", 'max_length': '10'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'123d1ee025004a9e94689d39224f4b2b'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'66d1c726ac1e4ab48a771631ad99f1a8'", 'unique': 'True', 'max_length': '32'}),
