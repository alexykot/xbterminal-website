...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Currency.postfix'
        db.add_column(u'website_currency', 'postfix',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'Currency.prefix'
        db.add_column(u'website_currency', 'prefix',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Currency.postfix'
        db.delete_column(u'website_currency', 'postfix')

        # Deleting field 'Currency.prefix'
        db.delete_column(u'website_currency', 'prefix')
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'a45f224a37ef44eda0d3676523f847ef'", 'unique': 'True', 'max_length': '32'}),
