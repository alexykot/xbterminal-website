...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WithdrawalOrder'
        db.create_table(u'website_withdrawalorder', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uid', self.gf('django.db.models.fields.CharField')(default=u'KWAYn8', unique=True, max_length=32)),
            ('device', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Device'])),
            ('bitcoin_network', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('merchant_address', self.gf('django.db.models.fields.CharField')(max_length=35)),
            ('customer_address', self.gf('django.db.models.fields.CharField')(max_length=35, null=True)),
            ('fiat_currency', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Currency'])),
            ('fiat_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2)),
            ('customer_btc_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=8)),
            ('tx_fee_btc_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=8)),
            ('exchange_rate', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=8)),
            ('outgoing_tx_id', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('time_sent', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('time_broadcasted', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('time_completed', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ))
        db.send_create_signal(u'website', ['WithdrawalOrder'])


    def backwards(self, orm):
        # Deleting model 'WithdrawalOrder'
        db.delete_table(u'website_withdrawalorder')
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'RmsR8ZDp'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'0896d711b579445499c40bc4550461cf'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.order': {
            ...
            'payment_reference': ('django.db.models.fields.CharField', [], {'default': "u'4CRQEFZAJE'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "u'V97C4E'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'613139863324456ca82a01c655c40ca2'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.withdrawalorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "u'4kjYkQ'", 'unique': 'True', 'max_length': '32'})
        }
    }
