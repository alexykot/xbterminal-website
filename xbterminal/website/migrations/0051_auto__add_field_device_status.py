...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'website_device', 'status',
                      self.gf('django.db.models.fields.CharField')(default='active', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Device.status'
        db.delete_column(u'website_device', 'status')
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'35557fba2ae54069a8a5f9b56f43ee36'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'78e07e9ef3444fff801365cf6494b836'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'0947ec7a35864e5086b9274e4907eb2d'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'c3d1cd868f1549bc852be45c94cef26d'", 'unique': 'True', 'max_length': '32'}),
