...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaymentOrder.receipt_key'
        db.add_column(u'website_paymentorder', 'receipt_key',
                      self.gf('django.db.models.fields.CharField')(max_length=32, unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PaymentOrder.receipt_key'
        db.delete_column(u'website_paymentorder', 'receipt_key')
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'D4uwL1zr'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'b6625c557715479a85fe98f1ae6632f1'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.order': {
            ...
            'payment_reference': ('django.db.models.fields.CharField', [], {'default': "u'CE9W4GQTME'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'website.paymentorder': {
            ...
            'transaction': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'paymentorder'", 'unique': 'True', 'null': 'True', 'to': u"orm['website.Transaction']"}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'40a0102fc6184c679bddd2d7655ec142'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'b7d4f1c4f5034c7389e5818af2236b11'", 'unique': 'True', 'max_length': '32'}),
