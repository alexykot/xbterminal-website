    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(storage=django.core.files.storage.FileSystemStorage(base_url=b'/verification/', location=b'/home/xuhcc/Documents/coding/xbt-website/xbterminal/../media/verification'), upload_to=website.files.verification_file_path_gen)),
