...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Device.our_fee_override'
        db.add_column(u'website_device', 'our_fee_override',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Device.our_fee_override'
        db.delete_column(u'website_device', 'our_fee_override')
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'f8b04938f1254f9c969979d9585c8073'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'bb4ae7247083404a9353a9f91ec85ab4'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'f0fb70fb19bd4438a457865ab4531628'", 'unique': 'True', 'max_length': '32'}),
