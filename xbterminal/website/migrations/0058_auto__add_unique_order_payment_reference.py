...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Order', fields ['payment_reference']
        db.create_unique(u'website_order', ['payment_reference'])


    def backwards(self, orm):
        # Removing unique constraint on 'Order', fields ['payment_reference']
        db.delete_unique(u'website_order', ['payment_reference'])
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'2RDvtNsQ'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'c307da0d8c484f36830877d63d7c923e'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.order': {
            ...
            'payment_reference': ('django.db.models.fields.CharField', [], {'default': "u'6ZRW2XVH9X'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'bcc3ca86a9674b74b36d103827c59db3'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'1a1223690fef4e158da61b5db74f979b'", 'unique': 'True', 'max_length': '32'}),
