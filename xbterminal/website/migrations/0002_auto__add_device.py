...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'website_device', (
            ...
            ('instantfiat', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('api_key', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('percent', self.gf('django.db.models.fields.SmallIntegerField')()),
            ('bitcoin_address', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
