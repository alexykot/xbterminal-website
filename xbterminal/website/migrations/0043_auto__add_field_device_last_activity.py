...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Device.last_activity'
        db.add_column(u'website_device', 'last_activity',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Device.last_activity'
        db.delete_column(u'website_device', 'last_activity')
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'be4e1bd40f65469599ef9bc4899030e1'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'24d19cca314245ad8b069bfaa35fb0a5'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'18868b7d170744deb08a8baad6a84bda'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'56ad585725d0449089ced04ad7f66a32'", 'unique': 'True', 'max_length': '32'}),
