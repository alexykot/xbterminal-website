...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.receipt_key'
        db.add_column(u'website_transaction', 'receipt_key',
                      self.gf('django.db.models.fields.CharField')(default='8e29be89ee4b4a11bbeb91cc5353b18b', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.receipt_key'
        db.delete_column(u'website_transaction', 'receipt_key')
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'bb2b3f0b26cb413fb43b24f52dbf06b2'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.transaction': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'a6492bf9f0d9412895dfd880558d8723'", 'unique': 'True', 'max_length': '32'}),
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'0820bfbdc43948459185949fff6769a6'", 'max_length': '32'}),
