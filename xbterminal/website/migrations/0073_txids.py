...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for payment_order in orm.PaymentOrder.objects.all():
            if payment_order.incoming_tx_id:
                incoming_tx_hash = x(payment_order.incoming_tx_id)
                payment_order.incoming_tx_id = b2lx(incoming_tx_hash)
            if payment_order.outgoing_tx_id:
                outgoing_tx_hash = x(payment_order.outgoing_tx_id)
    ...
    def backwards(self, orm):
        for payment_order in orm.PaymentOrder.objects.all():
            if payment_order.incoming_tx_id:
                incoming_tx_hash = lx(payment_order.incoming_tx_id)
                payment_order.incoming_tx_id = b2x(incoming_tx_hash)
            if payment_order.outgoing_tx_id:
                outgoing_tx_hash = lx(payment_order.outgoing_tx_id)
                payment_order.outgoing_tx_id = b2x(outgoing_tx_hash)
            payment_order.save()
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'EMgJuF1N'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'38d9d3ce709b427f90023bda855fe43a'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.order': {
            ...
            'payment_reference': ('django.db.models.fields.CharField', [], {'default': "u'8W4EUSDJVP'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'dba9b63a593b438eb6e0b0744fd10ce5'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'742f89a41e4849e3a953a72d0851358b'", 'unique': 'True', 'max_length': '32'}),
