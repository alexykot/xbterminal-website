...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'website_merchantaccount', 'business_address', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'MerchantAccount.contact_phone'
        db.alter_column(u'website_merchantaccount', 'contact_phone', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'MerchantAccount.post_code'
        db.alter_column(u'website_merchantaccount', 'post_code', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'MerchantAccount.user'
        db.alter_column(u'website_merchantaccount', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(default=1, unique=True, to=orm['website.User']))

        # Changing field 'MerchantAccount.town'
        db.alter_column(u'website_merchantaccount', 'town', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

    def backwards(self, orm):

        # Changing field 'MerchantAccount.business_address'
        db.alter_column(u'website_merchantaccount', 'business_address', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'MerchantAccount.contact_phone'
        db.alter_column(u'website_merchantaccount', 'contact_phone', self.gf('django.db.models.fields.CharField')(default='', max_length=32))

        # Changing field 'MerchantAccount.post_code'
        db.alter_column(u'website_merchantaccount', 'post_code', self.gf('django.db.models.fields.CharField')(default='', max_length=32))

        # Changing field 'MerchantAccount.user'
        db.alter_column(u'website_merchantaccount', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['website.User']))

        # Changing field 'MerchantAccount.town'
        db.alter_column(u'website_merchantaccount', 'town', self.gf('django.db.models.fields.CharField')(default='', max_length=64))
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'2tCmqxFh'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'b98942b3bb964f648ed30c6c39efe44d'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.order': {
            ...
            'payment_reference': ('django.db.models.fields.CharField', [], {'default': "u'S8GGGEFXAC'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'d743465f15b04b369ec609e0a6ddfb04'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'fba2e6d15aab4cc894a3bd0ea4a0970f'", 'unique': 'True', 'max_length': '32'}),
