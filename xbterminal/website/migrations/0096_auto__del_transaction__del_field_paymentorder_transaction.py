...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'website_transaction')

        # Deleting field 'PaymentOrder.transaction'
        db.delete_column(u'website_paymentorder', 'transaction_id')


    def backwards(self, orm):
        # Adding model 'Transaction'
        db.create_table(u'website_transaction', (
            ('instantfiat_invoice_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('receipt_key', self.gf('django.db.models.fields.CharField')(default='463dadcba1574b26bd2e98c2b4ce5eb7', max_length=32, unique=True)),
            ('dest_address', self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True)),
            ...
            ('bitcoin_transaction_id_1', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('bitcoin_transaction_id_2', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('fee_btc_amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=18, decimal_places=8, blank=True)),
            ('time', self.gf('django.db.models.fields.DateTimeField')()),
            ('instantfiat_btc_amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=18, decimal_places=8, blank=True)),
            ('instantfiat_address', self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True)),
            ('instantfiat_fiat_amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=2, blank=True)),
            ...
            ('hop_address', self.gf('django.db.models.fields.CharField')(max_length=35)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('btc_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=8)),
        ))
        db.send_create_signal(u'website', ['Transaction'])

        # Adding field 'PaymentOrder.transaction'
        db.add_column(u'website_paymentorder', 'transaction',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['website.Transaction'], unique=True, null=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'EjCqUzLo'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'839badf68bff46859ffdceb3cd1acfc7'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.order': {
            ...
            'payment_reference': ('django.db.models.fields.CharField', [], {'default': "u'HZWKM5UEEU'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "u'4NnGhA'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.withdrawalorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "u'N6PgGC'", 'unique': 'True', 'max_length': '32'})
        }
    }
