...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for merchant in orm.MerchantAccount.objects.all():
            if merchant.verification_file_1:
                merchant.kycdocument_set.create(
                    document_type=1,
                    status='unverified',
                    file=merchant.verification_file_1)
            if merchant.verification_file_2:
                merchant.kycdocument_set.create(
                    document_type=2,
                    status='unverified',
                    file=merchant.verification_file_2)
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'Dva5xL5p'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'2790f9e105b2465381043ba195a88dd8'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.order': {
            ...
            'payment_reference': ('django.db.models.fields.CharField', [], {'default': "u'MJS2WG1AJJ'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'97796925165b4caba82c82fbf9cbabd3'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'086f8b1a311d4259850a27fa4265bd8a'", 'unique': 'True', 'max_length': '32'}),
