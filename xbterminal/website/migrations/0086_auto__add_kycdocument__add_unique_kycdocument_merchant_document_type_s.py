...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'KYCDocument'
        db.create_table(u'website_kycdocument', (
            ...
            ('status', self.gf('django.db.models.fields.CharField')(default='uploaded', max_length=50)),
            ('gocoin_document_id', self.gf('django.db.models.fields.CharField')(max_length=36, null=True, blank=True)),
        ))
        db.send_create_signal(u'website', ['KYCDocument'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'KYCDocument'
        db.delete_table(u'website_kycdocument')
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'JtC27bUX'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'09c4f19149fd4ac9bdaf2405f960d6c7'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'version': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        u'website.kycdocument': {
            'Meta': {'unique_together': "(('merchant', 'document_type', 'status'),)", 'object_name': 'KYCDocument'},
        ...
        u'website.order': {
            ...
            'payment_reference': ('django.db.models.fields.CharField', [], {'default': "u'58RYKERQND'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'138b8e0532c34c288d433a87b50d25e8'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'117361cbc770441983cb8814d998b7e2'", 'unique': 'True', 'max_length': '32'}),
