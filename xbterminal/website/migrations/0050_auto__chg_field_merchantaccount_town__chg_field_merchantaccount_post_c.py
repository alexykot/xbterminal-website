...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MerchantAccount.town'
        db.alter_column(u'website_merchantaccount', 'town', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'MerchantAccount.post_code'
        db.alter_column(u'website_merchantaccount', 'post_code', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'MerchantAccount.contact_last_name'
        db.alter_column(u'website_merchantaccount', 'contact_last_name', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'MerchantAccount.business_address'
        db.alter_column(u'website_merchantaccount', 'business_address', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'MerchantAccount.county'
        db.alter_column(u'website_merchantaccount', 'county', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'MerchantAccount.company_name'
        db.alter_column(u'website_merchantaccount', 'company_name', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'MerchantAccount.trading_name'
        db.alter_column(u'website_merchantaccount', 'trading_name', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'MerchantAccount.contact_phone'
        db.alter_column(u'website_merchantaccount', 'contact_phone', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'MerchantAccount.business_address1'
        db.alter_column(u'website_merchantaccount', 'business_address1', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'MerchantAccount.business_address2'
        db.alter_column(u'website_merchantaccount', 'business_address2', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'MerchantAccount.contact_first_name'
        db.alter_column(u'website_merchantaccount', 'contact_first_name', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Order.delivery_address'
        db.alter_column(u'website_order', 'delivery_address', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Order.delivery_town'
        db.alter_column(u'website_order', 'delivery_town', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'Order.delivery_post_code'
        db.alter_column(u'website_order', 'delivery_post_code', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Order.delivery_address2'
        db.alter_column(u'website_order', 'delivery_address2', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Order.delivery_county'
        db.alter_column(u'website_order', 'delivery_county', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'Order.delivery_address1'
        db.alter_column(u'website_order', 'delivery_address1', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Order.delivery_contact_phone'
        db.alter_column(u'website_order', 'delivery_contact_phone', self.gf('django.db.models.fields.CharField')(max_length=32))

    def backwards(self, orm):

        # Changing field 'MerchantAccount.town'
        db.alter_column(u'website_merchantaccount', 'town', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'MerchantAccount.post_code'
        db.alter_column(u'website_merchantaccount', 'post_code', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'MerchantAccount.contact_last_name'
        db.alter_column(u'website_merchantaccount', 'contact_last_name', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'MerchantAccount.business_address'
        db.alter_column(u'website_merchantaccount', 'business_address', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'MerchantAccount.county'
        db.alter_column(u'website_merchantaccount', 'county', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'MerchantAccount.company_name'
        db.alter_column(u'website_merchantaccount', 'company_name', self.gf('django.db.models.fields.CharField')(max_length=254))

        # Changing field 'MerchantAccount.trading_name'
        db.alter_column(u'website_merchantaccount', 'trading_name', self.gf('django.db.models.fields.CharField')(max_length=254))

        # Changing field 'MerchantAccount.contact_phone'
        db.alter_column(u'website_merchantaccount', 'contact_phone', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'MerchantAccount.business_address1'
        db.alter_column(u'website_merchantaccount', 'business_address1', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'MerchantAccount.business_address2'
        db.alter_column(u'website_merchantaccount', 'business_address2', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'MerchantAccount.contact_first_name'
        db.alter_column(u'website_merchantaccount', 'contact_first_name', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'Order.delivery_address'
        db.alter_column(u'website_order', 'delivery_address', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'Order.delivery_town'
        db.alter_column(u'website_order', 'delivery_town', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'Order.delivery_post_code'
        db.alter_column(u'website_order', 'delivery_post_code', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'Order.delivery_address2'
        db.alter_column(u'website_order', 'delivery_address2', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'Order.delivery_county'
        db.alter_column(u'website_order', 'delivery_county', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Order.delivery_address1'
        db.alter_column(u'website_order', 'delivery_address1', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'Order.delivery_contact_phone'
        db.alter_column(u'website_order', 'delivery_contact_phone', self.gf('django.db.models.fields.CharField')(max_length=1000))
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'b2e5628a9466428bbbed79ff9a3c6be6'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'6f14d774ba8f417187502937c00b469c'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'0d9a69dadcaf45d79cfdf7562e8b9beb'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'222584bd3c51471fac625c30a97eb919'", 'unique': 'True', 'max_length': '32'}),
