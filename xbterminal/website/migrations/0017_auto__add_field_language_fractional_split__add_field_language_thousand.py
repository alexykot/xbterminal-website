...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Language.fractional_split'
        db.add_column(u'website_language', 'fractional_split',
                      self.gf('django.db.models.fields.CharField')(default='.', max_length=1),
                      keep_default=False)

        # Adding field 'Language.thousands_split'
        db.add_column(u'website_language', 'thousands_split',
                      self.gf('django.db.models.fields.CharField')(default=',', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Language.fractional_split'
        db.delete_column(u'website_language', 'fractional_split')

        # Deleting field 'Language.thousands_split'
        db.delete_column(u'website_language', 'thousands_split')
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'62b0553366754382bcb1f60c53487c94'", 'unique': 'True', 'max_length': '32'}),
