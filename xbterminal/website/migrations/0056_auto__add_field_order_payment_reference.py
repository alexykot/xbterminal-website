...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.payment_reference'
        db.add_column(u'website_order', 'payment_reference',
                      self.gf('django.db.models.fields.CharField')(default=u'RBHR51HE1B', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.payment_reference'
        db.delete_column(u'website_order', 'payment_reference')
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'7ubAZR41'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'09d5bf1476b44461afca29b44e112185'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.order': {
            ...
            'payment_reference': ('django.db.models.fields.CharField', [], {'default': "u'HS4KFKSR9K'", 'max_length': '10'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'df252f1e295d4d6b93f930f411134718'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'08ae9101cea8415c8639cb9ca0c6a587'", 'unique': 'True', 'max_length': '32'}),
