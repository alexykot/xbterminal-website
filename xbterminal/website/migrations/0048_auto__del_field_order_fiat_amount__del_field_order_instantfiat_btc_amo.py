...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Order.fiat_amount'
        db.rename_column(u'website_order', 'fiat_amount', 'fiat_total_amount')

        # Renaming field 'Order.instantfiat_btc_amount'
        db.rename_column(u'website_order', 'instantfiat_btc_amount', 'instantfiat_btc_total_amount')

        # Adding field 'Order.created'
        db.add_column(u'website_order', 'created',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'website_order', 'created')

        # Renaming field 'Order.fiat_total_amount'
        db.rename_column(u'website_order', 'fiat_total_amount', 'fiat_amount')

        # Renaming field 'Order.instantfiat_btc_total_amount'
        db.rename_column(u'website_order', 'instantfiat_btc_total_amount', 'instantfiat_btc_amount')
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'18a4116cb42146cc9b55d1e210e208e1'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'3e628cbec4614767bae9ea1636c3663b'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'fe48f781b51f4880ad9db2c8f7991ceb'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'1bea30306cdd40d38891569ec86a492f'", 'unique': 'True', 'max_length': '32'}),
