...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaymentOrder.payment_type'
        db.add_column(u'website_paymentorder', 'payment_type',
                      self.gf('django.db.models.fields.CharField')(default='bip0021', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PaymentOrder.payment_type'
        db.delete_column(u'website_paymentorder', 'payment_type')
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'4NuuqTXh'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'9d84588c498f49a7b2228a1a9e464260'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.order': {
            ...
            'payment_reference': ('django.db.models.fields.CharField', [], {'default': "u'PHGFCTOTRG'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'a67c81cb1a7548628e7ff7d5760a8061'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'34faeee64c9944bea523dad6555b57e2'", 'unique': 'True', 'max_length': '32'}),
