...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MerchantAccount.account_balance'
        db.add_column(u'website_merchantaccount', 'account_balance',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=8),
                      keep_default=False)

        # Adding field 'MerchantAccount.account_balance_max'
        db.add_column(u'website_merchantaccount', 'account_balance_max',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=8),
                      keep_default=False)

        # Adding field 'MerchantAccount.account_address'
        db.add_column(u'website_merchantaccount', 'account_address',
                      self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MerchantAccount.account_balance'
        db.delete_column(u'website_merchantaccount', 'account_balance')

        # Deleting field 'MerchantAccount.account_balance_max'
        db.delete_column(u'website_merchantaccount', 'account_balance_max')

        # Deleting field 'MerchantAccount.account_address'
        db.delete_column(u'website_merchantaccount', 'account_address')
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'Lj9atWap'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'4482c7db1888449c97877255d24f96f6'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.merchantaccount': {
            ...
            'account_address': ('django.db.models.fields.CharField', [], {'max_length': '35', 'null': 'True', 'blank': 'True'}),
            'account_balance': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '20', 'decimal_places': '8'}),
            'account_balance_max': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '20', 'decimal_places': '8'}),
        ...
        u'website.order': {
            ...
            'payment_reference': ('django.db.models.fields.CharField', [], {'default': "u'V5WHPRTODQ'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "u'SHBNKg'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'2b04b16d6ee1421c8eb6535b59d3b23c'", 'unique': 'True', 'max_length': '32'}),
