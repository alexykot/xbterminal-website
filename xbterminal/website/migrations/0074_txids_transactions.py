...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for payment_order in orm.PaymentOrder.objects.all():
            if payment_order.transaction:
                transaction = orm.Transaction.objects.get(pk=payment_order.transaction.pk)
                if not payment_order.incoming_tx_id:
                    incoming_tx_hash = x(transaction.bitcoin_transaction_id_1)
                    payment_order.incoming_tx_id = b2lx(incoming_tx_hash)
                    payment_order.save()
                if not payment_order.outgoing_tx_id:
                    outgoing_tx_hash = x(transaction.bitcoin_transaction_id_2)
                    payment_order.outgoing_tx_id = b2lx(outgoing_tx_hash)
                    payment_order.save()
                transaction.bitcoin_transaction_id_1 = payment_order.incoming_tx_id
                transaction.bitcoin_transaction_id_2 = payment_order.outgoing_tx_id
                transaction.save()
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'VEJrt4Y3'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'54c478facb4f44e89b9daff046bbc369'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.order': {
            ...
            'payment_reference': ('django.db.models.fields.CharField', [], {'default': "u'QVCOCYGFYG'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'edd972f5ef9a4dcc8a6aa1a48a39b9a8'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'b4f88e9568c4401dbf3d472c1308f168'", 'unique': 'True', 'max_length': '32'}),
