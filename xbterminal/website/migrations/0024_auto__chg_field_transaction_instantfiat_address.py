...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Transaction.instantfiat_address'
        db.alter_column(u'website_transaction', 'instantfiat_address', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

    def backwards(self, orm):

        # Changing field 'Transaction.instantfiat_address'
        db.alter_column(u'website_transaction', 'instantfiat_address', self.gf('django.db.models.fields.CharField')(default='', max_length=35))
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'83f3b9bd4a6d42a2aa77846cdd09b952'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.transaction': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'10a387390927420b9c4187edd0dd77f7'", 'unique': 'True', 'max_length': '32'}),
