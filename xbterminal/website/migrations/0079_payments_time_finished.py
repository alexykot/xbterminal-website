...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for payment_order in orm.PaymentOrder.objects.all():
            if payment_order.transaction and not payment_order.time_finished:
                payment_order.time_finished = payment_order.transaction.time
                payment_order.save()
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'GsPA4xvx'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'718b8b8a977f4e1788814f5dc796a153'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.order': {
            ...
            'payment_reference': ('django.db.models.fields.CharField', [], {'default': "u'6HY3FUK6FX'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'47074129e2ae48458b36f8f819d5d435'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'91930c5168404a57a6b39a4118c0085f'", 'unique': 'True', 'max_length': '32'}),
