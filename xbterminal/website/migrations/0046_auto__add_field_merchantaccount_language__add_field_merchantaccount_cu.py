...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MerchantAccount.language'
        db.add_column(u'website_merchantaccount', 'language',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['website.Language']),
                      keep_default=False)

        # Adding field 'MerchantAccount.currency'
        db.add_column(u'website_merchantaccount', 'currency',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['website.Currency']),
                      keep_default=False)

        # Deleting field 'Device.comment'
        db.delete_column(u'website_device', 'comment')

        # Deleting field 'Device.language'
        db.delete_column(u'website_device', 'language_id')

        # Deleting field 'Device.currency'
        db.delete_column(u'website_device', 'currency_id')

        # Adding field 'Device.device_type'
        db.add_column(u'website_device', 'device_type',
                      self.gf('django.db.models.fields.CharField')(default='hardware', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MerchantAccount.language'
        db.delete_column(u'website_merchantaccount', 'language_id')

        # Deleting field 'MerchantAccount.currency'
        db.delete_column(u'website_merchantaccount', 'currency_id')

        # Adding field 'Device.comment'
        db.add_column(u'website_device', 'comment',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Device.language'
        db.add_column(u'website_device', 'language',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['website.Language']),
                      keep_default=False)

        # Adding field 'Device.currency'
        db.add_column(u'website_device', 'currency',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['website.Currency']),
                      keep_default=False)

        # Deleting field 'Device.device_type'
        db.delete_column(u'website_device', 'device_type')
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'f358ad9a0ee94113b761a0fcc3797f44'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'90078aa7380e4765ac2f5902e2a3e22c'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'2e718e6b53c441558c0994d3287e8ffa'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'1ed01ffc2a6e47038036166771f99896'", 'unique': 'True', 'max_length': '32'}),
