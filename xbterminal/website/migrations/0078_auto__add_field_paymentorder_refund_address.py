...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaymentOrder.refund_address'
        db.add_column(u'website_paymentorder', 'refund_address',
                      self.gf('django.db.models.fields.CharField')(max_length=35, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PaymentOrder.refund_address'
        db.delete_column(u'website_paymentorder', 'refund_address')
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'XnKAfDGx'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'02fd8e6417df48aa9e5f1c77aff99a3d'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.order': {
            ...
            'payment_reference': ('django.db.models.fields.CharField', [], {'default': "u'5G2EPK9TE6'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'786be794cfdf49eab8d59360e27974a3'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'ea4766eb81814ca29d783643938e1f9d'", 'unique': 'True', 'max_length': '32'}),
