...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'website_firmware', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hash', self.gf('django.db.models.fields.CharField')(default='ebd51f3d12b94006862d3b458e8b0426', unique=True, max_length=32)),
            ...
            ('filename', self.gf('django.db.models.fields.FilePathField')(path='/var/firmware', max_length=100)),
        ))
        db.send_create_signal(u'website', ['Firmware'])

        # Adding field 'Device.current_firmware'
        db.add_column(u'website_device', 'current_firmware',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='current_for_device_set', null=True, to=orm['website.Firmware']),
                      keep_default=False)
        ...
        db.add_column(u'website_device', 'next_firmware',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='next_to_device_set', null=True, to=orm['website.Firmware']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Firmware'
        db.delete_table(u'website_firmware')
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'a11d48a114a54cd4ac9883e1f40b34ec'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'9e78aa7c22b84996b1e8445729262311'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'bbad48e6b24749109236d3b9a4399f99'", 'unique': 'True', 'max_length': '32'}),
