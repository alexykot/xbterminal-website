...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MerchantAccount.payment_processor'
        db.alter_column(u'website_merchantaccount', 'payment_processor', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'MerchantAccount.api_key'
        db.alter_column(u'website_merchantaccount', 'api_key', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
        # Deleting field 'Device.api_key'
        db.delete_column(u'website_device', 'api_key')
    ...
    def backwards(self, orm):
        ...
        # Changing field 'MerchantAccount.payment_processor'
        db.alter_column(u'website_merchantaccount', 'payment_processor', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'MerchantAccount.api_key'
        db.alter_column(u'website_merchantaccount', 'api_key', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
        # Adding field 'Device.api_key'
        db.add_column(u'website_device', 'api_key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Device.payment_processor'
        db.add_column(u'website_device', 'payment_processor',
                      self.gf('django.db.models.fields.CharField')(default='GoCoin', max_length=50),
                      keep_default=False)
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'Qem1GqbB'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'b581d3bb49e64521b73d5d73ed5cf7b6'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.order': {
            ...
            'payment_reference': ('django.db.models.fields.CharField', [], {'default': "u'JNQCID4XQI'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'dd218815b2a943159c89cc0ffcafe46e'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'4b046a3e1147406187e2be1d004136f5'", 'unique': 'True', 'max_length': '32'}),
