...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'website_order', 'payment_status',
                      self.gf('django.db.models.fields.CharField')(default='unpaid', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.payment_status'
        db.delete_column(u'website_order', 'payment_status')
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'JQCJGEhn'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'162bdb49f17a43c9a03412e7873385df'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.order': {
            ...
            'payment_reference': ('django.db.models.fields.CharField', [], {'default': "u'LQ3JDKMVE7'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'35c713dd8e9f4f16a4c425b80f2474a8'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'c6b63023556e441f89ba4e315de445b2'", 'unique': 'True', 'max_length': '32'}),
