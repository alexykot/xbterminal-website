...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Device.percent'
        db.alter_column(u'website_device', 'percent', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=4, decimal_places=1))

    def backwards(self, orm):

        # Changing field 'Device.percent'
        db.alter_column(u'website_device', 'percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=1))
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'7G1mroJs'", 'unique': 'True', 'max_length': '32'}),
            ...
            'payment_processor': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'b17d9ee8b8df4c54915242a93bec1e95'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.order': {
            ...
            'payment_reference': ('django.db.models.fields.CharField', [], {'default': "u'HMZURZ1U7Y'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'328bea3a82994d66b1aff1ee0cf11e03'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'ac98a917c0044d049d99763474cb3bf7'", 'unique': 'True', 'max_length': '32'}),
