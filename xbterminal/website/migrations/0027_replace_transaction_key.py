...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for transaction in orm.Transaction.objects.all():
            transaction.receipt_key = transaction.key
            transaction.save()
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'74c75ef6ee9d4103a87915db9f5413ca'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.transaction': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'4a563847f875414db45ba7542df76cb0'", 'unique': 'True', 'max_length': '32'}),
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'2fee260f067e40dbb3ad017499b2aca2'", 'max_length': '32'}),
