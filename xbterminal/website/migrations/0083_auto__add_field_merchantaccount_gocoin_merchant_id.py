...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MerchantAccount.gocoin_merchant_id'
        db.add_column(u'website_merchantaccount', 'gocoin_merchant_id',
                      self.gf('django.db.models.fields.CharField')(max_length=36, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MerchantAccount.gocoin_merchant_id'
        db.delete_column(u'website_merchantaccount', 'gocoin_merchant_id')
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'4KTLt8cb'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.firmware': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'892aa3b3adc249c6bb9bb4cdc18fe276'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.order': {
            ...
            'payment_reference': ('django.db.models.fields.CharField', [], {'default': "u'DNTFUDGMKE'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'website.paymentorder': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'6bcee80f58b842b6a6b38ed3d5497475'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'eec0c9e80025466fab5e826996988984'", 'unique': 'True', 'max_length': '32'}),
