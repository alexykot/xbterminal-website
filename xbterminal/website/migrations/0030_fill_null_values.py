...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for t in orm.Transaction.objects.all():
            t.instantfiat_fiat_amount = t.instantfiat_btc_amount = t.fee_btc_amount = 0
            t.save()
    ...
    models = {
        ...
        u'website.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'9d660f38e1644051b5aae871d7cc3600'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'website.transaction': {
            ...
            'receipt_key': ('django.db.models.fields.CharField', [], {'default': "'d328829617624a8e83509c111b98fb6f'", 'unique': 'True', 'max_length': '32'}),
