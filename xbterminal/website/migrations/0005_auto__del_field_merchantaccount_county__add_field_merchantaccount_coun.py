...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MerchantAccount.county'
        db.delete_column(u'website_merchantaccount', 'county')

        # Adding field 'MerchantAccount.country'
        db.add_column(u'website_merchantaccount', 'country',
                      self.gf('django_countries.fields.CountryField')(default='', max_length=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'MerchantAccount.county'
        db.add_column(u'website_merchantaccount', 'county',
                      self.gf('django_countries.fields.CountryField')(default='', max_length=2, blank=True),
                      keep_default=False)

        # Deleting field 'MerchantAccount.country'
        db.delete_column(u'website_merchantaccount', 'country')
    ...
    models = {
        ...
        u'website.device': {
            ...
            'bitcoin_address': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'comment': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instantfiat': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'merchant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['website.MerchantAccount']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'percent': ('django.db.models.fields.SmallIntegerField', [], {})
        },
