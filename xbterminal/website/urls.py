...
urlpatterns = [
    ...
    url(r'^accounts/$',
        ...
        name='accounts'),
    url(r'^accounts/(?P<currency_code>\w{3,5})/$',
        views.EditAccountView.as_view(),
        name='account'),
    url(r'^accounts/(?P<currency_code>\w{3,5})/add_funds/$',
        views.AddFundsView.as_view(),
        name='account_add_funds'),
    url(r'^accounts/(?P<currency_code>\w{3,5})/withdraw/$',
        views.WithdrawToBankAccountView.as_view(),
        name='account_withdrawal'),
    url(r'^accounts/(?P<currency_code>\w{3,5})/transactions/$',
        views.AccountTransactionListView.as_view(),
        name='account_transactions'),
    url(r'^accounts/(?P<currency_code>\w{3,5})/report/$',
