...
urlpatterns = patterns('website.views',
    ...
    url(r'^terminals/(?P<device_key>[0-9a-fA-F]{32})/$', views.UpdateDeviceView.as_view(), name='device'),
    url(r'^terminals/(?P<device_key>[0-9a-fA-F]{32})/recon/$',
    ...
    url(r'^terminals/(?P<device_key>[0-9a-fA-F]{32})/pos$', views.PaymentView.as_view(), name='payment'),
)
